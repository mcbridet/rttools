...
This was originally a web app (still exists for now at at [https://tapeinfo.tx.au](https://tapeinfo.tx.au)), but it has since been improved and ported into a tool for programmatic use.
